    ...
    <main class="main-bg">
        ...
        <header class="slider showcase-full">
            <div class="swiper-container parallax-slider">      
                <div class="swiper-wrapper">
                                        ...
                                        <div class="caption">
                                            ...
                                            <h1>
                                                <a href="project-details1.html">
                                                    <span data-swiper-parallax="-2000">Concert and Stage Production</span>
                                                </a>
                                            </h1>
                                        </div>
                                    </div>
                    ...
                    @endforeach
                    {{-- <div class="swiper-slide">
                        <div class="bg-img valign" data-background="{{ asset('dark/assets/imgs/works/full/2.jpg') }}"
                            data-overlay-dark="3">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-11 offset-lg-1">
                    ...
                    <div class="swiper-slide">
                        <div class="bg-img valign" data-background="{{ asset('dark/assets/imgs/works/full/3.jpg') }}"
                            data-overlay-dark="3">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-11 offset-lg-1">
                    ...
                    <div class="swiper-slide">
                        <div class="bg-img valign" data-background="{{ asset('dark/assets/imgs/works/full/4.jpg') }}"
                            data-overlay-dark="3">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-11 offset-lg-1">
                    ...
                    <div class="swiper-slide">
                        <div class="bg-img valign" data-background="{{ asset('dark/assets/imgs/works/full/5.jpg') }}"
                            data-overlay-dark="3">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-11 offset-lg-1">
                    ...
                    <div class="swiper-slide">
                        <div class="bg-img valign" data-background="{{ asset('dark/assets/imgs/works/full/6.jpg') }}"
                            data-overlay-dark="3">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-11 offset-lg-1">
        ...
        <section class="pg-about section-padding sub-bg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="bg-img radius-10" data-background="{{ asset('dark/assets/imgs/about/sq1.jpg') }}"></div>
                    </div>
                    <div class="col-lg-8">

                        <h2>About Us</h2>
                        <h6>GoGoSprockets! is a full-service, in-house production company committed to making your special
                            event as completely unique and memorable as possible. This challenge is met with our valuable
                            years of experience, large inventory of equipment, our versatility and reliability, and most of
                            all, our creative production staff! Some of our photos look familiar to you?? That's because...
                            Yes! OUR pictures appear on others' websites. 'Cuz after you call them, who do you think they
                            call to do the job! </h6>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="item">
                                            <div class="img icon-img-100">
                                                <a href="#0">
                                                    <img src="{{ asset('dark/assets/imgs/clients/1.png') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="item">
                                            <div class="img icon-img-100">
                                                <a href="#0">
                                                    <img src="{{ asset('dark/assets/imgs/clients/2.png') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="item">
                                            <div class="img icon-img-100">
                                                <a href="#0">
                                                    <img src="{{ asset('dark/assets/imgs/clients/3.png') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="item">
                                            <div class="img icon-img-100">
                                                <a href="#0">
                                                    <img src="{{ asset('dark/assets/imgs/clients/4.png') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="item">
                                            <div class="img icon-img-100">
                                                <a href="#0">
                                                    <img src="{{ asset('dark/assets/imgs/clients/5.png') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="item">
                                            <div class="img icon-img-100">
                                                <a href="#0">
                                                    <img src="{{ asset('dark/assets/imgs/clients/6.png') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="item">
                                            <div class="img icon-img-100">
                                                <a href="#0">
                                                    <img src="{{ asset('dark/assets/imgs/clients/7.png') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="item">
                                            <div class="img icon-img-100">
                                                <a href="#0">
                                                    <img src="{{ asset('dark/assets/imgs/clients/8.png') }}"
                                                        alt="">
                                                </a>
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-5 valign">
                        <div class="serv-tab-link tab-links full-width md-mb50">
                            ...
                            <div class="row">
                                <div class="col-lg-10">
                                    <ul class="rest">
                                        <li class="item-link current mb-15 pb-15 bord-thin-bottom" data-tab="tabs-1">
                                            <span>01</span> UI/UX
                                            Design</li>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <div class="img circle-60">
                                                        <img src="{{ asset('dark/assets/imgs/testim/1.jpg') }}"
                                    ...
                                    <div class="swiper-slide">
                                        <div class="item">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <div class="img circle-60">
                                                        <img src="{{ asset('dark/assets/imgs/testim/2.jpg') }}"
                                                            alt="" class="circle-img">
                                                    </div>
                                                </div>
                                                <div class="ml-30">

    ...
    <div class="container-fluid mt-5">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('addabout') }}"><button class="btn btn-primary" style="float:right;">Add</button></a><br><br>
                                ...
                                @foreach ($image as $key => $images)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('editabout', $images->id) }}"
                                                class="btn btn-info btn-sm waves-effect">
                                                <i class="fa fa-edit" style="font-size:20px">
                                                </i>
                                            </a>
                                            <form method="POST" action="{{ route('deleteabout', $images->id) }}">
                                                @csrf 
                                                @method('delete')
